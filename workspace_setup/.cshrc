...
setenv PATH /tools/B/ayan_biswas/programs/core/bin:${PATH}
...
setenv LD_LIBRARY_PATH $/tools/B/ayan_biswas/programs/core/lib:${LD_LIBRARY_PATH}
setenv LD_LIBRARY_PATH $/tools/B/ayan_biswas/programs/core/lib64:${LD_LIBRARY_PATH}
